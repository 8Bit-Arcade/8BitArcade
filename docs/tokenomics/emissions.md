...
| Source | Tokens/Month | % of Emissions | Annual Total |
|--------|--------------|----------------|--------------|
| **Daily Rewards** | 1,500,000 | 60% | 18,000,000 |
| **Standard Tournaments** | 180,000 | 7.2% | 2,160,000 |
| **High Roller Tournaments** | 820,000 | 32.8% | 9,840,000 |
| **TOTAL** | **2,500,000** | **100%** | **30,000,000** |
...
| Quarter | Emissions | Circulating Supply | Inflation Rate |
|---------|-----------|-------------------|----------------|
| Q1 | 7,500,000 | ~207.5M | 3.6% |
| Q2 | 7,500,000 | ~215M | 3.5% |
| Q3 | 7,500,000 | ~222.5M | 3.4% |
| Q4 | 7,500,000 | ~230M | 3.3% |
...
```
Month 0 (Launch):     200,000,000 (40%)
Month 3:              207,500,000 (41.5%)
Month 6:              215,000,000 (43%)
Month 12 (Year 1):    230,000,000 (46%)
Month 24 (Year 2):    260,000,000 (52%)
Month 36 (Year 3):    290,000,000 (58%)
Month 48 (Year 4):    320,000,000 (64%)
Month 60 (Year 5):    350,000,000 (70%)
```
...
| Project | Distribution Period | Annual Inflation | Model |
|---------|-------------------|------------------|-------|
| **8-Bit Arcade** | **5 years** | **6-15%** | **Front-loaded** |
| Bitcoin | 100+ years | 1.8% | Halving every 4 years |
| Ethereum | Infinite | 0.5% | Minimal issuance |
| Axie Infinity | 20+ years | 15-30% | Slow distribution |
| DeFi Kingdoms | 30+ years | 20-40% | Very slow |
...
- **[Rewards Contract](https://arbiscan.io)** - View minting events
- **[Supply Tracker](https://8bitarcade.games/supply)** - Live circulating supply
- **[Burn Address](https://arbiscan.io)** - Tokens permanently removed
- **[Emission Calendar](https://8bitarcade.games/calendar)** - Scheduled distributions
...
- [Deflationary Model](deflationary.md) - How burns reduce supply
- [Market Scenarios](market-scenarios.md) - Token price projections
- [Daily Rewards](../earning/daily-rewards.md) - How to earn
- [Tournaments](../earning/tournaments.md) - Competition prizes
