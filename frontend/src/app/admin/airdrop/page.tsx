    ...
    <div className="min-h-screen bg-arcade-black p-4">
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-3xl font-pixel text-arcade-green">AIRDROP ALLOCATIONS</h1>
          <div className="flex gap-2">
            <a
              href="/admin/airdrop-controls"
              className="bg-blue-600 text-white px-4 py-2 font-pixel text-sm hover:bg-blue-500"
            >
              CONTROLS
            </a>
            <button
